      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
             ...
             <form action="{{ route('booking.store') }}" method="post" enctype="multipart/form-data" class="bg-white p-md-5 p-4 mb-5 border">
              @csrf
              <div class="row">
              ...
              <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="room">room</label>
          ...
          <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="{{ asset('frontend/images/person_1') }}" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="{{ asset('frontend/images/person_2') }}" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="{{ asset('frontend/images/person_3') }}" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
